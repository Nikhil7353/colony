...
class PluginManager:
    ...
    def unset_plugin_instance_diffusion_scope_loaded_plugins_map(self, diffusion_scope_id, plugin_id) -> None: ...
    def add_plugin_dependent_plugins_map(self, plugin_id, dependency_plugin_instance) -> None: ...
    def get_plugin_dependent_plugins_map(self, plugin_id): ...
    def clear_plugin_dependent_plugins_map(self, plugin_id) -> None: ...
    def add_plugin_allowed_plugins_map(self, plugin_id, allowed_plugin_info_list) -> None: ...
    ...
    def _get_plugin_by_id_and_version(self, plugin_id, plugin_version) -> Plugin | None: ...
    ...
    def resolve_file_path(self, file_path, not_found_valid: bool = False, create_path: bool = False): ...
    ...
    def get_plugin_configuration_paths_by_id(self, plugin_id, extra_paths: bool = False): ...
