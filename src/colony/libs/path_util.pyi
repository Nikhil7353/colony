...
def copy_link(source_path: PathLike[str], target_path: PathLike[str], replace_file: bool = ...): ...
def copy_file(source_path: PathLike[str], target_path: PathLike[str], replace_file: bool = ...): ...
...
def _relative_path_windows(path: PathLike[str], start_path: PathLike[str] = ...) -> PathLike[str]: ...
def _relative_path_posix(path: PathLike[str], start: PathLike[str] = ...) -> PathLike[str]: ...
def _abspath_split(
    path: PathLike[str],
