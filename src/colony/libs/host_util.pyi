...
def get_addresses_family(filter_family: AddressFamily, filter_addresses: Sequence[str] = ...) -> Sequence[str]: ...
def get_address_tuples() -> Sequence[tuple[AddressFamily, SocketKind, int, str, Any]]: ...
