...
def unique() -> int: ...
def notify(
    operation_name: str, handlers_map: Mapping[str, Sequence[Callable]] | None = ..., *arguments, **named_arguments
) -> Any: ...
def message(handlers_map: HandlersMap | None = ..., *arguments, **named_arguments) -> Any: ...
def action(handlers_map: HandlersMap | None = ..., *arguments, **named_arguments) -> Any: ...
def progress(handlers_map: HandlersMap | None = ..., *arguments, **named_arguments) -> Any: ...
