...
def object_flatten(instance: Any, flattening_map: Mapping[Any, Any]) -> Sequence[Any]: ...
def object_print_list(instances_list: Sequence[Any]): ...
def object_print(instance: Any): ...
def _object_flatten(instances_list: Sequence[Any], flattening_map: Mapping[Any, Any]) -> Sequence[Any]: ...
