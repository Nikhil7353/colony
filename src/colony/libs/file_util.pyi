...
class FileRotator:
    ...
    def open(self): ...
    def close(self): ...
    def write(self, string_value: bytes | str, flush: bool = ..., encoding: str = ...): ...
...
class FileContext:
    ...
    def remove_directory(self, directory_path: PathLike[str], handle_exception: bool = ...): ...
    def remove_file(self, file_path: PathLike[str], handle_exception: bool = ...): ...
    def remove_directory_immediate(self, directory_path: PathLike[str], handle_exception: bool = ...): ...
