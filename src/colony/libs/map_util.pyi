...
def map_check_parameters(map: Mapping[T, Any], parameters_list: Sequence[T], exception: Type[Exception] = ...): ...
def map_get_value_cast(map: Mapping[T, Any], key: T, cast_type: Type = ..., default_value: Any | None = ...) -> Any: ...
